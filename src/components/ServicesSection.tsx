...
const ServiceCard = ({ icon: Icon, title, description, color, bgColor }) => {
  return (
    <div className="flex items-start p-4 rounded-lg mb-4 hover:shadow-md transition-all duration-300 bg-white">
